    ...
    const fetchData = async () => {
      try {
        ...
        if (deptRes.data.success) {
          ...
          // Find 'Delivery' department and lock it
          const deliveryDept = deptRes.data.data.find((d: any) => d.name === 'Delivery');
          if (deliveryDept) {
            setSelectedDept(deliveryDept.id);
          }
        }
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const res = await axios.post('https://napi.bharatmedicalhallplus.com/employees', {
        ...
        email,
        password,
        department: selectedDeptObj?.name || 'Delivery',
          ...
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formContainer}>
              <View style={styles.formTitleRow}>
                <View>
                  <Text style={styles.pageTitle}>Delivery Staff Registration</Text>
                  <Text style={styles.pageSubtitle}>Join our delivery fleet.</Text>
                </View>
              ...
              <View style={styles.sectionCard}>
                ...
                <View style={styles.gridContainer}>
                  <View style={[styles.inputGroup, { width: '100%', display: 'none' }]}>
                  ...
                  {selectedDept ? (
                    <View style={[styles.inputGroup, { width: '100%', zIndex: 900 }]}>
                      <Text style={styles.label}>Delivery Role *</Text>
              ...
              <View style={styles.loginLinkRow}>
                ...
                <TouchableOpacity activeOpacity={0.7} onPress={() => router.push('/employee/login')}>
