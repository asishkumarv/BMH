...
import { View, Text, StyleSheet, Pressable, Platform, TextInput, KeyboardAvoidingView, ScrollView, Alert, ActivityIndicator } from 'react-native';
...
export default function SubAdminLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.post('http://localhost:5000/admin/department-admins/login', {
        email,
        password
      });
