...
export default function PatientHistoryDepartment() {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Department Patient History</Text>
        ...
        history.map((record, index) => (
          <View key={index} style={styles.recordCard}>
            ...
            <View style={styles.notesBox}>
              <Text style={styles.notesLabel}>Medical Notes & Prescription:</Text>
              <Text style={styles.notesContent}>{record.notes || 'No notes provided.'}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  notesLabel: { fontSize: 14, fontWeight: '600', color: Colors.light.text, marginBottom: 8 },
  notesContent: { fontSize: 14, color: '#475569', lineHeight: 22, backgroundColor: '#f8fafc', padding: 16, borderRadius: 8 },
