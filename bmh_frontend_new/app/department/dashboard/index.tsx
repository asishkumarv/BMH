...
import { Users, FileText, CheckCircle, Clock, Sun, Moon, Utensils, CheckCircle2, AlertTriangle, CalendarRange, ChevronRight, IndianRupee } from 'lucide-react-native';
          ...
          <View style={[styles.chartCard, { marginBottom: 24 }]}>
            ...
            {hasAppointmentsAccess && (
              <TouchableOpacity 
                ...
                onPress={() => router.push('/department/dashboard/appointments' as any)}
              >
            ...
            {hasBillingAccess && (
              <TouchableOpacity 
                ...
                onPress={() => router.push('/department/dashboard/billing' as any)}
              >
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
