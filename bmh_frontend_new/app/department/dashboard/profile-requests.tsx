  ...
  useEffect(() => {
    const fetchRequests = async () => {
      ...
      try {
        ...
        const url = deptName ? `https://bmh-eitu.onrender.com/profile-requests?department_name=${deptName}` : 'https://bmh-eitu.onrender.com/profile-requests';
        ...
        <View style={styles.cardHeader}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View>
              ...
              <Text style={styles.userType}>{item.department_name} Department</Text>
            </View>
          </View>
