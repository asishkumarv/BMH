...
const styles = StyleSheet.create({
  ...
  list: { maxHeight: 300 },
  patientCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: 'white', padding: 16, borderRadius: 8, marginBottom: 8, borderWidth: 1, borderColor: '#e2e8f0', flexWrap: 'wrap', gap: 8 },
  tokenText: { fontSize: 16, fontWeight: 'bold', color: Colors.light.primary },
  patientName: { fontSize: 14, color: '#334155', flexWrap: 'wrap' },
  ...
  currentCard: { backgroundColor: 'white', padding: 24, borderRadius: 12, alignItems: 'center', borderWidth: 2, borderColor: '#bfdbfe' },
  currentToken: { fontSize: 40, fontWeight: 'bold', color: '#1e3a8a', marginBottom: 8, textAlign: 'center' },
  currentName: { fontSize: 22, fontWeight: 'bold', color: '#1e40af', marginBottom: 24, textAlign: 'center' },
  completeBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#10b981', paddingHorizontal: 16, paddingVertical: 12, borderRadius: 12, flexWrap: 'wrap', justifyContent: 'center' },
