...
export default function EmployeeNotificationsScreen() {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get(`https://bmh-eitu.onrender.com/notifications?user_type=employee&user_id=${empUser.id}`);
      if (res.data.success) {
    ...
    <View style={styles.container}>
      <View style={[styles.header, !isDesktop && styles.headerMobile]}>
        <View>
          ...
          <Text style={styles.subtitle}>Stay updated on your assigned tasks</Text>
        </View>
