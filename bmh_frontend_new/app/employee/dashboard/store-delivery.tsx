...
export default function StoreDeliveryScreen() {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true);
      let userDataStr = Platform.OS === 'web' ? localStorage.getItem('employeeUser') : await AsyncStorage.getItem('employeeUser');
      if (!userDataStr) {
      ...
      const res = await axios.get(`https://napi.bharatmedicalhallplus.com/employees/store-delivery/assigned?userId=${userId}`);
