  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backLink} onPress={() => router.replace('/admin/dashboard')}>
          <ArrowLeft size={16} color={Colors.light.primary} style={{ marginRight: 6 }} />
          <Text style={styles.backLinkText}>Back to Dashboard</Text>
        </TouchableOpacity>
        <Text style={styles.title}>Today's Appointment & Queue Manager</Text>
        <Text style={styles.subtitle}>Monitor live patient queues, track doctor availability, and manage appointments in real time.</Text>
...
const styles = StyleSheet.create({
  ...
  dateFilterContainer: { flexDirection: 'row', alignItems: 'center', marginTop: 14, gap: 10 },
  dateLabel: { fontSize: 14, fontWeight: '700', color: '#475569' },
  dateInput: { borderWidth: 1, borderColor: '#cbd5e1', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6, backgroundColor: 'white', color: '#334155', width: 140, fontSize: 14 },
  goBtn: { backgroundColor: Colors.light.primary, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  goBtnText: { color: 'white', fontWeight: 'bold', fontSize: 13 },

  rowTitle: { fontSize: 15, fontWeight: 'bold', color: '#475569', marginTop: 12, marginBottom: 8, textTransform: 'uppercase' },
  statsRow: { flexDirection: 'row', gap: 16 },
  statsRowMobile: { flexDirection: 'column' },
  kpiCard: { flex: 1, backgroundColor: 'white', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#e2e8f0', borderLeftWidth: 5, flexDirection: 'row', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 1 },
  kpiIconContainer: { width: 40, height: 40, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  kpiValue: { fontSize: 22, fontWeight: 'bold', color: '#0f172a' },
  kpiLabel: { fontSize: 11, fontWeight: '600', color: '#64748b', marginTop: 2, textTransform: 'uppercase' },
