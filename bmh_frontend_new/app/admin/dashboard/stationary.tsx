...
export default function AdminStationaryScreen() {
    ...
    const executeReject = async () => {
      try {
        ...
        const res = await axios.put(`https://napi.bharatmedicalhallplus.com/stationary/refills/${refillId}/reject`, {
          rejected_by_name: u ? u.full_name : 'Super Admin',
          rejected_by_role: u ? u.role || u.label : 'Super Admin',
  ...
  const handleAssignTask = async () => {
    ...
    let assignerType = u ? u.type : 'super_admin';
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 12 }}>
                <View style={{ backgroundColor: '#FFF', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 8, borderWidth: 1, borderColor: '#E2E8F0' }}>
                  ...
                  {Platform.OS === 'web' ? (
                    ...
                    >
                      {uniqueDepartments.map(d => <Picker.Item key={d} label={d} value={d} />)}
                    </Picker>
                  )}
                </View>
