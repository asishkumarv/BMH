...
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, ActivityIndicator, Alert, TextInput, Modal, Dimensions } from 'react-native';
...
export default function ClinicOverviewDashboard() {
  ...
  const loadDashboardData = async (dateStr: string) => {
    ...
    try {
      ...
      const [bookingsRes, slotsRes, docRes, billingRes1, billingRes2, billingRes3] = await Promise.all([
      ...
      if (billingRes1.data.success) {
        ...
        setLists(billingRes1.data.lists);
      }
