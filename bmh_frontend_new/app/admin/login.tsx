...
import { View, Text, StyleSheet, Pressable, Platform, TextInput, KeyboardAvoidingView, ScrollView, Alert } from 'react-native';
...
export default function AdminLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.post('http://localhost:5000/admin/super-admins/login', {
        email,
        password
      });
