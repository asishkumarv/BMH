    ...
    let query = `
      WITH combined_orders AS (
        ...
        SELECT 
          ...
          po.status,
          NULL::varchar as created_by_id,
          'System'::varchar as created_by_type,
          ...
          po.delivered_at,
          NULL::varchar as modified_by_id,
          NULL::varchar as modified_by_type,
          NULL::varchar as modified_by_name,
